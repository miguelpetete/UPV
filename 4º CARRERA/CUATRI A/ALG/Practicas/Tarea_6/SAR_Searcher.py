...
if __name__ == "__main__":
    ...
    group2.add_argument('-SU', '--suggester', dest='suggester', action='store_true', default=False, 
                    help='uses the suggester in case the querry doesnt give results.')

    group2.add_argument('-TR', '--trie', dest='trie', action='store_true', default=False, 
                    help='uses the suggester with TRIE data structure in case the querry doesnt give results.')
    ...
    searcher.set_suggester(args.suggester)
    searcher.set_trieSugester(args.trie)
